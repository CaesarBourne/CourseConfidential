...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private Button startRegisterActivity;
...
// profile. ID and basic profile are included in DEFAULT_SIGN_IN.
        ...
        startRegisterActivity = findViewById(R.id.startRegister);
        startRegisterActivity.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(LoginActivity.this, "sorry authentication failed",Toast.LENGTH_LONG).show();
                            updateUI(null);
                            showProgress(false);
                        }
...
//            }
    ...
    private void updateUIGoogle(GoogleSignInAccount account) {
        Toast.makeText(LoginActivity.this,"You have succesfully signed in" + account.getEmail()+" " +
...
//        }
        ...
        if (cancel) {
            ...
            showProgress(true);
            loginCore.loginImpexUser(email, password, this);
...
//            mAuthTask.execute((Void) null);
    ...
    public void loginUserSuccesful(){
        Toast.makeText(this, "You have succefuly logged in as a Impex user", Toast.LENGTH_LONG).show();
    ...
    public void loginFailure(){
        showProgress(false);
        Toast.makeText(this, "You are not a registered user, Sign Up today", Toast.LENGTH_LONG).show();
    }

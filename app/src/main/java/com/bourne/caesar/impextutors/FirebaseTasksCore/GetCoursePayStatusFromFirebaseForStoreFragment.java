...
public class GetCoursePayStatusFromFirebaseForStoreFragment {
 StoresFragment storesFragment;

    public GetCoursePayStatusFromFirebaseForStoreFragment(StoresFragment storesFragment) {
        ...
        databaseReference.child(Constants.IMPEX_USER)
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                       ...
                       storesFragment.getCoursePayStatusSuccess(coursesPaidList);
                    }

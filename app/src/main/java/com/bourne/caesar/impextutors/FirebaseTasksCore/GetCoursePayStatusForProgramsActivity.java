...
public class GetCoursePayStatusForProgramsActivity {

    ProgramFeaturesActivity programFeaturesActivity;

    public GetCoursePayStatusForProgramsActivity(ProgramFeaturesActivity programFeaturesActivity) {
        this.programFeaturesActivity = programFeaturesActivity;
    }

    public void getCoursePayStatus(){
        ...
        databaseReference.child(Constants.IMPEX_USER)
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        programFeaturesActivity.getCoursePayStatusSuccess(coursesPaidList);
                    }

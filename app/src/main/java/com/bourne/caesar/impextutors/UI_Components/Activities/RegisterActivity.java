...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "impex@example.com:hello", "tutors@example.com:world"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startLoginActivity = findViewById(R.id.startLogin);
        populateAutoComplete();

        startLoginActivity.setOnClickListener(new OnClickListener() {
            @Override
    ...
    public void initialization(){
        registrationCore = new RegistrationCore(this);
        addImpexUserToFirebase = new AddImpexUserToFirebase(this);
    }
...
//        }
        ...
        // Check for a valid password, if the user entered slideone.
        ...
        // Check for a valid password alone
...
//            mAuthTask.execute((Void) null);
    ...
    public void registerationfailure(){
        showProgress(false);
        Toast.makeText(this, "Registeration wasnt succesful poor internet or" +
                " remove your background data restriction", Toast.LENGTH_LONG);

    }
    public void addUserSuccess(String success){
    ...
    public void addUserFailure(){
        Toast.makeText(this, "You are werent succesfully added please register again", Toast.LENGTH_LONG);
    }
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                ...
                // a primary email address if the user hasn't specified slideone.
